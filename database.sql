...
--
-- Хост: localhost
-- Время создания: Ноя 15 2017 г., 03:55
...
--
CREATE DATABASE `db_xogoc_7` DEFAULT CHARACTER SET cp1251 COLLATE cp1251_general_ci;
USE `db_xogoc_7`;
...
(1, 'тестовый анонимный отзыв', 'Аноним'),
(2, 'Ура, отзывы работают!', 'Константин'),
(3, 'тест', 'К.И. Ходосевич'),
(5, 'тест тест тест тест тест тест тест тест тест тест тест тест тест тест тест тест тест \r\nedited by admin again', 'тестed'),
...
(9, 'agl.jpg', 'img/gallery/', 331976, 13);
